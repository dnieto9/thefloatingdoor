...
public class testPiece : MonoBehaviour
{
    ...
    private List<testPiece> connectedPieces = new List<testPiece>(); // Use a list to store connected pieces
    ...
    private void checkInPlace(testPiece other) /// check if connected with other
    {
